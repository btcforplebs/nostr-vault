...
#ifndef HAVEN_SWIFT_H
#define HAVEN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HAVEN",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5HAVEN11AppDelegate")
...
@class NSCoder;
SWIFT_CLASS("_TtC5HAVEN19AspectFillImageView")
...
SWIFT_CLASS("_TtC5HAVEN15WebSocketClient")
